...
export const getPartTimerById = (id: string) => api(`/api/part-timers/${id}`);
export const createPartTimer = (data: NewPartTimer) => api('/api/part-timers', { method: 'POST', body: JSON.stringify(data) });
export const updatePartTimer = (id: string, data: Partial<NewPartTimer>) => api(`/api/part-timers/${id}`, { method: 'PUT', body: JSON.stringify(data) });
export const deletePartTimer = (id: string) => api(`/api/part-timers/${id}`, { method: 'DELETE' });
...
export const updateEvent = (id: string, data: Partial<NewEvent>) => api(`/api/events/${id}`, { method: 'PUT', body: JSON.stringify(data) });
export const deleteEvent = (id: string) => api(`/api/events/${id}`, { method: 'DELETE' });
...
export const updateEventDailyAssignment = (id: string, data: Partial<NewEventDailyAssignment>) => api(`/api/event-daily-assignments/${id}`, { method: 'PUT', body: JSON.stringify(data) });
...
export const updateEventStaffSalary = (id: string, data: Partial<NewEventStaffSalary>) => api(`/api/event-staff-salaries/${id}`, { method: 'PUT', body: JSON.stringify(data) });
...
export const getAttendanceById = (id: string) => api(`/api/attendance/${id}`);
...
export const updateAttendance = (id: string, data: Partial<NewAttendance>) => api(`/api/attendance/${id}`, { method: 'PUT', body: JSON.stringify(data) });
export const deleteAttendance = (id: string) => api(`/api/attendance/${id}`, { method: 'DELETE' });

// Payroll
export const getAllPayroll = () => api('/api/payroll');
export const getPayrollById = (id: string) => api(`/api/payroll/${id}`);
...
export const updatePayroll = (id: string, data: Partial<NewPayroll>) => api(`/api/payroll/${id}`, { method: 'PUT', body: JSON.stringify(data) });
export const deletePayroll = (id: string) => api(`/api/payroll/${id}`, { method: 'DELETE' });
